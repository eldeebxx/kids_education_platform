...
class _TeacherPageState extends State<TeacherPage> {
                    ...
                    Positioned(
                      ...
                      child: Hero(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('assets/images/boy1Big.png'),
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Row(
                          children: [
                            courseWidget('icon1', 'Young \nLearners',
                                'GRADE 0-1', kLightBlue, kDarkBlue),
                            courseWidget('icon2', 'Creative \nBloomers',
                                'GRADE 0-2', kYellow, Color(0xff4d4d4d)),
                            courseWidget('icon3', 'Early \nArchievers',
                                'GRADE 0-3', kPink, Color(0xff4a155f)),
                          ],
                        ),
                      ),
                    ),
  ...
  Container timeSlotWidget(String time, bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.all(Radius.circular(10)),
        color: (isSelected) ? kPink : kLightBlue.withOpacity(0.5),
      ),
      child: Row(
        children: [
          Icon(
  ...
  InkWell dateWidget(int i) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.all(Radius.circular(10)),
          color: (selectedDate == dateTime.day)
              ? kYellow
